...
struct ESwitch : Module {
    ...
    ESwitch() {
        ...
        configParam(P_S1_POLY_PARAM, 0.f, 16.f, 8.f, "Split 1 Poly");
        configParam(P_S2_POLY_PARAM, 0.f, 16.f, 8.f, "Split 2 Poly");
        configParam(P_S3_POLY_PARAM, 0.f, 16.f, 0.f, "Split 3 Poly");
        configParam(P_S4_POLY_PARAM, 0.f, 16.f, 0.f, "Split 4 Poly");

        configInput(IN_SELECT_INPUT, "Selector");
        ...
        configInput(IN4_LIGHTS_INPUT, "Split 3 LED");

...
struct ESwitchWidget : ModuleWidget {
	ESwitchWidget(ESwitch* module) {
		...
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(24.052, 46.463)), module, ESwitch::IN_SELECT_INPUT));
		...
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(30.029, 118.359)), module, ESwitch::IN_LIGHTS_INPUT));
		...
		addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(43.509, 118.359)), module, ESwitch::OUT_LIGHTS_OUTPUT));
	}
};

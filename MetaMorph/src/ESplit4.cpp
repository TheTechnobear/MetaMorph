...
struct ESplit4Widget : ModuleWidget {
  ESplit4Widget(ESplit4 *module) {
    ...
    addParam(createParamCentered<RoundBlackKnob>(
        mm2px(Vec(8.929, 58.215)), module, ESplit4::P_S1_NROW_PARAM));
    addParam(createParamCentered<RoundBlackKnob>(
        mm2px(Vec(23.745, 58.215)), module, ESplit4::P_S1_POLY_PARAM));
    addParam(createParamCentered<RoundBlackKnob>(
        mm2px(Vec(8.929, 77.265)), module, ESplit4::P_S2_NROW_PARAM));
    addParam(createParamCentered<RoundBlackKnob>(
        mm2px(Vec(23.745, 77.794)), module, ESplit4::P_S2_POLY_PARAM));
    addParam(createParamCentered<RoundBlackKnob>(
        mm2px(Vec(8.929, 96.844)), module, ESplit4::P_S3_NROW_PARAM));
    addParam(createParamCentered<RoundBlackKnob>(
        mm2px(Vec(23.745, 97.373)), module, ESplit4::P_S3_POLY_PARAM));
    addParam(createParamCentered<RoundBlackKnob>(
        mm2px(Vec(8.929, 115.894)), module, ESplit4::P_S4_NROW_PARAM));
    addParam(createParamCentered<RoundBlackKnob>(
        mm2px(Vec(23.745, 116.423)), module, ESplit4::P_S4_POLY_PARAM));

    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(22.763, 32.772)), module,
                                             ESplit4::IN_ENABLE_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(37.355, 32.772)), module,
                                             ESplit4::IN_K_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(49.433, 32.772)), module,
                                             ESplit4::IN_X_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(61.51, 32.772)), module,
                                             ESplit4::IN_Y_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(73.588, 32.772)), module,
                                             ESplit4::IN_Z_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(85.195, 32.772)), module,
                                             ESplit4::IN_KG_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(98.869, 58.215)), module,
                                             ESplit4::IN1_LIGHTS_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(98.869, 77.794)), module,
                                             ESplit4::IN2_LIGHTS_INPUT));
    addInput(createInputCentered<PJ301MPort>(mm2px(Vec(98.869, 97.373)), module,
                                             ESplit4::IN3_LIGHTS_INPUT));
    addInput(createInputCentered<PJ301MPort>(
        mm2px(Vec(98.869, 116.423)), module, ESplit4::IN4_LIGHTS_INPUT));

    addOutput(createOutputCentered<PJ301MPort>(
        mm2px(Vec(98.285, 32.772)), module, ESplit4::OUT_LIGHTS_OUTPUT));
    addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(38.496, 58.215)),
                                               module, ESplit4::OUT1_K_OUTPUT));
    addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(50.574, 58.215)),
                                               module, ESplit4::OUT1_X_OUTPUT));
    addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(62.652, 58.215)),
                                               module, ESplit4::OUT1_Y_OUTPUT));
    addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(74.73, 58.215)),
                                               module, ESplit4::OUT1_Z_OUTPUT));
    addOutput(createOutputCentered<PJ301MPort>(
        mm2px(Vec(85.456, 58.215)), module, ESplit4::OUT1_KG_OUTPUT));
    addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(38.496, 77.794)),
                                               module, ESplit4::OUT2_K_OUTPUT));
    addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(50.574, 77.794)),
                                               module, ESplit4::OUT2_X_OUTPUT));
    addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(62.652, 77.794)),
                                               module, ESplit4::OUT2_Y_OUTPUT));
    addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(74.73, 77.794)),
                                               module, ESplit4::OUT2_Z_OUTPUT));
    addOutput(createOutputCentered<PJ301MPort>(
        mm2px(Vec(85.742, 77.794)), module, ESplit4::OUT2_KG_OUTPUT));
    addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(38.496, 97.373)),
                                               module, ESplit4::OUT3_K_OUTPUT));
    addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(50.574, 97.373)),
                                               module, ESplit4::OUT3_X_OUTPUT));
    addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(62.652, 97.373)),
                                               module, ESplit4::OUT3_Y_OUTPUT));
    addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(74.73, 97.373)),
                                               module, ESplit4::OUT3_Z_OUTPUT));
    addOutput(createOutputCentered<PJ301MPort>(
        mm2px(Vec(85.456, 97.373)), module, ESplit4::OUT3_KG_OUTPUT));
    addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(38.496, 116.423)),
                                               module, ESplit4::OUT4_K_OUTPUT));
    addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(50.574, 116.423)),
                                               module, ESplit4::OUT4_X_OUTPUT));
    addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(62.652, 116.423)),
                                               module, ESplit4::OUT4_Y_OUTPUT));
    addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(74.73, 116.423)),
                                               module, ESplit4::OUT4_Z_OUTPUT));
    addOutput(createOutputCentered<PJ301MPort>(
        mm2px(Vec(85.742, 116.423)), module, ESplit4::OUT4_KG_OUTPUT));
  }
};
...
void ESplit4::doProcess(const ProcessArgs &args) {
  ...
  for (unsigned splitId = 0; splitId < MAX_SPLIT; splitId++) {
    ...
    unsigned maxVoices =
        params[P_S1_POLY_PARAM + (splitId * PARAM_N)].getValue();
    ...
    if (maxVoices > 0 && nRow > 0) {
      ...
      for (unsigned ch = 0; ch < nChannels; ch++) {
        ...
        bool inSplit = (in_r >= startR && in_r <= endR) &&
        ...
        if (valid && inSplit) {
          ...
          if (v) {
            ...
            outputs[OUT1_K_OUTPUT + (splitId * OUT_N)].setVoltage(
                encodeKey(r, c), v->voiceId_);
            outputs[OUT1_X_OUTPUT + (splitId * OUT_N)].setVoltage(inX,
                                                                  v->voiceId_);
            outputs[OUT1_Y_OUTPUT + (splitId * OUT_N)].setVoltage(inY,
                                                                  v->voiceId_);
            outputs[OUT1_Z_OUTPUT + (splitId * OUT_N)].setVoltage(inZ,
                                                                  v->voiceId_);
          }
        } else {
          ...
          if (v) {
            voices.freeVoice(v);
            outputs[OUT1_K_OUTPUT + (splitId * OUT_N)].setVoltage(0.f,
                                                                  v->voiceId_);
            outputs[OUT1_X_OUTPUT + (splitId * OUT_N)].setVoltage(0.f,
                                                                  v->voiceId_);
            outputs[OUT1_Y_OUTPUT + (splitId * OUT_N)].setVoltage(0.f,
                                                                  v->voiceId_);
            outputs[OUT1_Z_OUTPUT + (splitId * OUT_N)].setVoltage(0.f,
                                                                  v->voiceId_);
          }
        }
      }  // for channel
      ...
      if (ledmsg != 0.0f) {
        ...
        float msg =
            encodeLedMsg(t, startr + startR, startc + startC, sizer, sizec);
        ledQueue_.write(msg);
      }
    } else {
